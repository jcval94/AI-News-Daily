...
class SelectionResult(BaseModel):
    items: List[SelectedNewsItem] = Field(max_length=MAX_SELECTED_NEWS)
...
- When two items cover the same event, keep the clearest and most authoritative source.
...
- The first 15 seconds already use shorter canonical slots; honor them exactly.
""",
