...
from pipeline.media_sources.video_search.plan import matches, normalize
...
def discover(plan, sources: list[str], per_query=15) -> tuple[list[dict], list[dict]]:
    from pipeline.media_sources.video_search.alternatives import PROVIDERS as alternatives
