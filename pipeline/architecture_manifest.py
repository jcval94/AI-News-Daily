...
DESIGN_DECISIONS = [
    ...
    ("Ingest no equivale a selección artística", "El scanner conserva todos los retakes y sólo marca un technical_preferred provisional. Transcripción/alignment puede elegir otra toma; los crudos nunca se borran ni se commitean."),
