...
STAGES: list[dict[str, Any]] = [
    ...
    {"id": "local_harness", "kind": "local_control", "title": "Windows Local Editing Harness", "summary": "Frontera segura entre contratos canónicos y la workstation Windows 11: doctor/capabilities, roots lógicos, jobs allowlisted, receipts idempotentes, Resolve discovery/OTIO smoke y ejecución sin shell arbitrario.", "inputs": "config/local + .local/local_config.json + jobs declarativos", "outputs": ".local/preflight.latest.json + receipts/logs locales + efectos verificados en Resolve", "authority": "Python/PowerShell deterministas; nunca expone shell arbitrario y nunca sube raw media", "code": "pipeline/local/* · scripts/local/* · docs/local/README.md", "trace_steps": []},
